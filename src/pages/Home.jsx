    ...
    return (
        <div className="home-page">
            ...
            <section className="hero-section text-center flex items-center justify-center">
                <div className="hero-content container" style={{ maxWidth: '900px' }}>
                    ...
                    <div className="hero-buttons flex justify-center gap-md animate-fade-in-up delay-200">
                        <Link to="/shop" className="btn btn-primary bg-white text-primary hover:bg-secondary hover:text-white border-none px-2xl">Shop Collection</Link>
                    </div>
                </div>
            </section>
            ...
            <section className="section about-section bg-light">
                <div className="container grid-2-col items-center gap-xl">
                    <div className="about-image-wrapper">
                        <img src="https://placehold.co/600x500/2F6F4E/FFFFFF?text=Our+Story" alt="Ayurvedic herbs" className="rounded-lg shadow-lg" />
                    </div>
                    <div className="about-content">
                        <h4 className="text-secondary uppercase tracking-wide text-sm font-bold mb-sm">Our Story</h4>
                        <h2 className="section-title text-left mb-md">Ancient Wisdom, Modern Purity</h2>
                        ...
                        <div className="features-mini-grid">
                            <div className="flex items-center gap-sm mb-sm">
                                <Leaf className="text-primary" size={24} /> <span>100% Natural Ingredients</span>
                            </div>
                            <div className="flex items-center gap-sm mb-sm">
                                <ShieldCheck className="text-primary" size={24} /> <span>Certified Authentic</span>
                            </div>
                        </div>

                        <Link to="/about" className="btn btn-outline mt-md">Read More About Us</Link>
                    </div>
                </div>
            </section>
